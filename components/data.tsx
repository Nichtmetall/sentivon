...
export const Services = [
    { id: 0, title: 'Digital Consulting', description: 'Get a better understanding of where your traffic is coming from.', href: '#', icon: faComments, },
    { id: 1, title: 'Suchmaschinenoptimierung', description: 'Get a better understanding of where your traffic is coming from.', href: '#', icon: faGoogle, },
    { id: 3, title: 'Werbung', description: 'Get a better understanding of where your traffic is coming from.', href: '#', icon: faBullhorn, },
    { id: 2, title: 'Webentwicklung', description: 'Get a better understanding of where your traffic is coming from.', href: '#', icon: faLaptopCode, },
    { id: 5, title: 'E-Commerce', description: 'Get a better understanding of where your traffic is coming from.', href: '#', icon: faStore, },
]
